...
public class test {
    ...
    public static void main(String[] args) {
        String path = "e:\\wechat\\org";
        String targetPath = "e:\\wechat\\tag";
        ...
        */
        ...
        FILE_TYPE_MAP.put("5374616E64617264204A", "mdb"); //MS Access (http://www.amjmh.com)
